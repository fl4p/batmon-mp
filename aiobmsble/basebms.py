...
try:
    ...
    async def establish_connection(client_class,
                                   ...
                                   services):
        assert name == device.address, "name doesnt match address"
        client = client_class(device, disconnected_callback=disconnected_callback, services=services)
...
class BaseBMS(ABC):
    ...
    def __init__(
        ...
        self._client: BleakClient = BleakClient(
            ...
            services=list(self.uuid_services()),
        )
